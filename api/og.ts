...
export default function handler(req: VercelRequest, res: VercelResponse): void {
  ...
  ${ellipsePaths}
  <text x="${cx}" y="${cy}" text-anchor="middle" dominant-baseline="central" font-family="SFZimmerman, sans-serif" font-size="${FONT_SIZE}" letter-spacing="0.15em" fill="black">${escapeXml(title)}</text>
</svg>`;
