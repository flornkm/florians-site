  ...
  variants: {
    variant: {
      default: [
        ...
        "prose-p:text-secondary prose-p:text-sm prose-p:leading-relaxed",
        "prose-li:text-secondary prose-li:text-sm prose-li:leading-relaxed prose-li:marker:text-quaternary/50",
