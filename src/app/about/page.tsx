          ...
          <div className="flex gap-8 max-lg:flex-col max-md:gap-4 max-w-lg row-span-1 max-md:order-2 max-md:mb-24 md:pt-4 md:pb-16">
            <div className="justify-center flex flex-col">
              ...
              <p className="text-zinc-600 dark:text-zinc-300 mb-2">
                ...
                &nbsp;years old. I am a designer and developer and I love to
                create beautiful products. Currently I am studying at the
                Hochschule fuer Gestaltung, also known as just HfG, in
                Schwaebisch Gmuend, Germany.
              </p>
              <p className="text-zinc-600 dark:text-zinc-300">
                Beside my desire to work between design and code I love working
                with CSS and creating animations for web and mobile
                applications.
              </p>
            </div>
          </div>
