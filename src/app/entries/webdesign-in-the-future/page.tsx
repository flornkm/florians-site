          ...
          <>
            <article className="text-gray-700 dark:text-gray-300">
              ...
              <p className="mb-16">
                ...
                popular. Many tech-people used the term &quot;Web 3.0&quot; to
                describe the next stage of the internet. But what does that
                mean? And what will the internet look like in the future?
              </p>
              <h3 className="text-xl font-medium mb-2 text-black dark:text-white">
                Web 3.0 is misleading
              </h3>
              <p className="mb-16">
                The term &quot;Web 3.0&quot; is often used in combination with
                crypto. But I don&apos;t think that this makes sense. I
                don&apos;t hate crypto, but I think because of the recent events
                (FTX) a lot of things will change and crypto will get much more
                regulated. Therefore I think cryptocurrencies will not be the
                main focus of the next stage of the internet. I think the main
                focus will be on decentralization, artificial intelligence and
                future technologies like quantum computing.
              </p>
              <h3 className="text-xl font-medium mb-2 text-black dark:text-white">
              ...
              <p className="mb-24">
                ...
                and more accurate. You don&apos;t need to go to the doctor
                anymore, because you can use the internet to diagnose yourself
                with a computer that is controlled over the cloud, extemely fast
                and developed to recognize diseases.
                <br />
