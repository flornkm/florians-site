...
function CreationGrid() {
  ...
  const activatePopup = (concept: any) => {
    if (concept.title === "Nutri") {
      ...
      currentConcept.current.icon = "/images/icons/nutri_icon.jpg"
      ...
      currentConcept.current.icon = "/images/icons/stackoverflow_icon.jpg"
      currentConcept.current.video = null
      currentConcept.current.mainImages = [
      ...
      currentConcept.current.icon = "/images/icons/visualization_icon.jpg"
      currentConcept.current.video = null
      currentConcept.current.mainImages = [
      ...
      currentConcept.current.icon = "/images/icons/heartbeatos_icon.jpg"
      currentConcept.current.video = null
      currentConcept.current.mainImages = [
      ...
      currentConcept.current.icon = "/images/icons/web_audit_icon.jpg"
      ...
      currentConcept.current.shortDescription =
        "AI Chatbot for Shopping made in 48h"
      currentConcept.current.icon = "/images/icons/granny_ai_icon.jpg"
      currentConcept.current.video =
