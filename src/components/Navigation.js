...
export default function Navigation(title, highlight) {
  return (
    <div className="w-full fixed md:border-b max-md:border max-md:rounded-full max-md:w-[80%] max-md:left-[50%] max-md:translate-x-[-50%] max-md:bottom-8 bg-white z-50 overflow-hidden dark:bg-[#0C131E] dark:border-gray-800">
