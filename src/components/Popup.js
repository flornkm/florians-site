          ...
          {name && (
            <div className="fixed inset-0 overflow-y-auto">
              <div className="flex min-h-full items-center justify-center p-4 text-center">
                ...
                >
                  <Dialog.Panel className="w-full max-w-5xl transform rounded-2xl bg-white text-left align-middle shadow-xl transition-all">
                    <div className="overflow-y-auto max-h-[80vh] p-6">
                      ...
                      <h3 className="text-xl font-medium mb-1">About</h3>
                      <p className="text-gray-700">{text}</p>
                      {links && (
                        <div className="mt-10">
                          <div className="flex w-full justify-between p-4 bg-gray-100 rounded-lg place-items-center max-sm:place-items-start max-sm:flex-col max-sm:gap-8">
