...
export default function ColophonOverview() {
  return (
    <>
      <h1 className="text-3xl font-semibold text-left mb-3">Colophon</h1>
      <p className="text-base mb-24">
        A colophon describes the methods, tools, and materials used to make a
        creative work. On this site you&apos;ll therefore find information from
