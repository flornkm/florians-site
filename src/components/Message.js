export default function Message({ msg, type }) {
  return (
    <>
      {type === "left" && <div className={"p-2 rounded-xl bg-primary text-white relative bottom-[16px] left-8 transition-all max-w-[300px] max-sm:max-w-[70%] self-start"}>
        {msg}
      ...
      {type === "right" && <div className="p-2 rounded-xl bg-primary text-white relative bottom-4 right-8 transition-all max-w-[300px] self-end">
        {msg}
