    ...
    >
      ...
      <div className="w-full flex gap-2 pl-3 pr-3 min-h-[64px] place-items-center justify-between max-sm:pb-3 max-sm:flex-wrap">
        <Menu as="div" className="relative inline-block text-left">
          ...
          >
            <Menu.Items ref={menu} className="absolute font-medium overflow-hidden left-0 top-[-128px] z-10 origin-bottom-left rounded-xl bg-white shadow-lg ring-1 ring-black ring-opacity-5 outline-none focus:outline-none dark:bg-zinc-800 dark:ring-zinc-700 p-1">
              <div className="py-0">
        ...
        <div className="w-full h-[48px] bg-white rounded-full border border-solid border-zinc-300 relative dark:border-zinc-700">
          <input
            ref={input}
