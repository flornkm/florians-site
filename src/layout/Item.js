    ...
    return (
      ...
      (id === "3" && (
        <div
          ...
          style={inlineStyles}
          className={
            "max-md:row-span-1 border-gray-200 relative p-8 bg-gray-50 border w-full h-full items-center justify-center flex rounded-xl max-md:min-h-[300px]"
          }
          {...props}
        >
      ...
      (id === "4" && (
        <div
          ...
          style={inlineStyles}
          className={
            "max-md:row-span-1 p-2 border-gray-200 relative bg-gray-50 border w-full h-full items-center justify-center flex flex-col gap-4 rounded-xl max-md:min-h-[300px]"
          }
          {...props}
        >
          <AudioPlayer
