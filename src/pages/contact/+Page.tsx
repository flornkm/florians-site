...
export default function Page() {
  return (
    <ChatStatusProvider>
      <div className="lg:grid pb-4 flex -mt-8 flex-col grid-rows-[auto_1fr] lg:grid-rows-1 min-h-[calc(100vh-5rem)] lg:min-h-[calc(100vh-6rem)] lg:w-screen lg:max-w-[calc(32rem+100vw/2)] lg:-ml-[calc((100vw-64rem)/4)] relative lg:left-1/2 lg:-translate-x-1/2 lg:grid-cols-2 mx-auto overflow-hidden">
