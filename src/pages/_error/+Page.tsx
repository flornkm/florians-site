...
export default function Page() {
  ...
  if (pageContext.is404) {
    return (
      <div className="w-full h-screen flex flex-col items-start justify-center max-w-sm mx-auto px-4">
        ...
        <p className="text-ms text-text-tertiary mb-5">But no worries, here are some pages you can try instead.</p>
  ...
  return (
    <div className="w-full h-screen flex flex-col items-start justify-center max-w-sm mx-auto px-4">
      ...
      <p className="text-ms text-text-tertiary mb-5">Internal server error. Please try again later.</p>
