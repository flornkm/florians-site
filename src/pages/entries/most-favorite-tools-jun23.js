          ...
          <>
            <article className="text-gray-700 dark:text-gray-300">
              <h3 className="text-xl font-medium mb-2 text-black dark:text-white mt-16">
                Cron <br /><span className="text-gray-500 text-lg">Business Calendar</span>
              </h3>
              <p className="mb-6">
              ...
              <h3 className="text-xl font-medium mb-2 text-black dark:text-white mt-16">
                GitHub <br /><span className="text-gray-500 text-lg">Use it for more, than just a hub for Git!</span>
              </h3>
              <p className="mb-6">
