          ...
          <>
            <article className="text-gray-700 dark:text-gray-300">
              <h3 className="text-xl font-medium mb-2 text-black dark:text-white mt-16">
                Retro <br /><span className="text-gray-500 text-lg">A mix between BeReal and Instagram</span>
              </h3>
              <p className="mb-6">
              ...
              <h3 className="text-xl font-medium mb-2 text-black dark:text-white mt-16">
                NordPass <br /><span className="text-gray-500 text-lg">A free and simple password manager</span>
              </h3>
              <p className="mb-6">
              ...
              <h3 className="text-xl font-medium mb-2 text-black dark:text-white mt-16">
                TicketSwap <br /><span className="text-gray-500 text-lg">A fast way to sell tickets for events you won't attend</span>
              </h3>
              <p className="mb-6">
