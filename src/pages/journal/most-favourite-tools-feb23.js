          ...
          <>
            <article className="text-gray-700 dark:text-gray-300">
              ...
              <p className="mb-6">
                ...
                lot of different featured that are helping us to fulfill our
              ...
              <p className="mb-6">
                Cosmos a relatively new platform and browser extension. It is 
                ...
                design is extraordinary good and it has a free version. <br />
                I am looking forward to use it for saving my favourite findings
                from around the internet. I just can recommend it to everyone,
                but make sure to install the browser extension because it will 
              ...
              <p className="mb-6">
                Rive is a tool I know for a while now, but because I was so
                used to Lottie, I never really used it. But recently I started
                to use it more (see the animation on my About page). Rive is
                a tool that allows you to create animations in a very easy way,
                the big benefit in my opinion is, that their own format is 
                extrmeley small and can be used in a lot of different ways.
                You can also create your designs directly in their editor and
                then switch to the animation tab and create your animations.
                <br />
                It is also possible to create animations directly based around 
