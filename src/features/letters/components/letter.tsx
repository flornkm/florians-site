...
const letterVariants = cva(
  "aspect-a4 shrink-0 w-full shadow-lg shadow-black/[.03] h-64 md:h-80 active:cursor-grabbing mx-auto p-4 bg-surface border-primary rounded-xl border flex",
  {
    variants: {
      variant: {
    ...
    compoundVariants: [
      ...
      },
      {
        variant: "preview",
        isEmpty: false,
        className: "scale-100 shadow-lg shadow-black/[.03]",
      },
      {
        variant: "preview",
        isDragging: false,
