...
<Video src="/collection/spinning-objects/spinning-objects.webm" autoPlay muted loop playsInline className="w-full object-cover aspect-video" />


## How to do it

<img className="w-20" src="/collection/spinning-objects/brick.png" alt="MidJourney Image" />
...
<Video src="/collection/spinning-objects/raw-rotating-block.mp4" autoPlay muted loop playsInline className="max-w-24 aspect-square object-contain" />
...
<Video webm="/videos/rotating-block.webm" mp4="/videos/rotating-block.mp4" autoPlay muted loop playsInline className="max-w-24 aspect-square object-contain" />
