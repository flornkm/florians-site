...
<Video webm="/videos/sona-hero.webm" className="rounded-xl" />

## Interactions & Animations

We put a lot of care into the micro-interactions and animations to make Sona feel polished and delightful to use.

<Video webm="/videos/sona-mobile-modal.webm" className="rounded-xl" />

<div className="not-prose my-8 grid grid-cols-1 md:grid-cols-2 gap-4">
  <Video webm="/videos/bouncy-slider-sona.webm" className="rounded-xl" />
  <Video webm="/videos/sona-subtle-animation.webm" className="rounded-xl" />
</div>
...
<Video webm="/videos/rive_swift_sona.webm" className="rounded-xl" />
