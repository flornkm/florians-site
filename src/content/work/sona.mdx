...
<Video webm="/videos/sona-hero.webm" className="rounded-lg" />

## Interactions & Animations

We put a lot of care into the micro-interactions and animations to make Sona feel polished and delightful to use.

<Video webm="/videos/sona-mobile-modal.webm" className="rounded-lg" />

<div className="not-prose my-8 grid grid-cols-1 md:grid-cols-2 gap-4">
  <Video webm="/videos/bouncy-slider-sona.webm" className="rounded-lg" />
  <Video webm="/videos/sona-subtle-animation.webm" className="rounded-lg" />
</div>
...
<div className="not-prose my-8">
  <img src="/images/sona/sona-hero-animation-how.png" alt="Sona hero animation breakdown" className="w-full h-auto rounded-lg" />
</div>

<Video webm="/videos/rive_swift_sona.webm" className="rounded-lg" />

## Launch

<Video src="/videos/sona.webm" className="rounded-lg" />
