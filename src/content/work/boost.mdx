...
<div className="not-prose my-8">
  <img src="/images/boost/boost.webp" alt="Boost device" className="w-full h-auto rounded-xl" />
</div>
...
<div className="not-prose my-8">
  <img src="/images/boost/boost-branding.webp" alt="Boost branding" className="w-full h-auto rounded-xl" />
</div>

<div className="not-prose my-8 grid grid-cols-1 md:grid-cols-2 gap-4">
  <img src="/images/boost/boost-custom-icons.webp" alt="Boost custom icons" className="w-full h-auto rounded-xl" />
  <img src="/images/boost/boost-packaging.webp" alt="Boost packaging" className="w-full h-auto rounded-xl" />
</div>
...
<div className="not-prose my-8">
  <img src="/images/boost/boost-device.webp" alt="Boost hardware device" className="w-full h-auto rounded-xl" />
</div>
...
<Video webm="/videos/powder_machine.webm" className="rounded-xl" />
...
<div className="not-prose my-8">
  <img src="/images/boost/boost-mobile-sketches.webp" alt="Boost mobile app sketches" className="w-full h-auto rounded-xl" />
</div>
...
<div className="not-prose my-8">
  <img src="/images/boost/boost-nutrition.webp" alt="Boost nutrition interface" className="w-full h-auto rounded-xl" />
</div>

<Video src="/videos/boost-device.mp4" className="rounded-xl" autoPlay muted loop playsInline />
