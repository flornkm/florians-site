...
export default function Page() {
  return (
    <div class="w-full">
      <section class="w-full lg:pt-16 relative min-h-screen flex flex-col max-w-3xl mb-32">
        ...
        <div class="text-zinc-500 mb-16 dark:text-zinc-400">
          ...
          <p class="mb-16">
            ...
            this Agreement) refers to Design With Tech.
            <br />
            <br />
            Cookies are small files that are placed on Your computer, mobile
            device or any other device by a website, containing the details of
            Your br /owsing history on that website among its many uses.
            <br />
            <br />
            ...
            <br />
            <br />
            Website refers to Design With Tech, accessible from
            https://designwithtech.com/
            <br />
            <br />
          ...
          <p class="mb-16">
            ...
            Protocol address (e.g. IP address), br /owser type, br /owser
            ...
            operating system, the type of mobile Internet br /owser You use,
            unique device identifiers and other diagnostic data.
            <br />
            <br />
            We may also collect information that Your br /owser sends whenever
            ...
            <br />
            <br />
            Cookies or br /owser Cookies. A cookie is a small file placed on
            Your Device. You can instruct Your br /owser to refuse all Cookies
            ...
            Service. Unless you have adjusted Your br /owser setting so that it
            ...
            as soon as You close Your web br /owser. You can learn more about
          ...
          <p>
            ...
            may be publicly distributed outside. With Your consent: We may
            ...
            <br />
            <br />
            Delete Your Personal Data You have the right to delete or request
            ...
            <br />
            By email:{" "}
            <InlineLink link="mailto:hello@floriankiem.com">
