        ...
        (props.type !== "text"
          ? "font-semibold rounded-xl transition-all duration-200 border px-5 py-2.5 " +
            (props.type === "primary"
              ...
              : "text-black bg-zinc-50 hover:bg-white hover:text-zinc-800 border-zinc-200 dark:text-white dark:bg-zinc-900 dark:hover:bg-zinc-900/75 dark:hover:text-zinc-200 dark:border-zinc-800")
